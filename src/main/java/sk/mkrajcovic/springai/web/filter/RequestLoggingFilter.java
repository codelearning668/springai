package sk.mkrajcovic.springai.web.filter;
 ...
 */
@ConditionalOnProperty(name = "sprinai.request-logging.enabled", havingValue = "true")
@Component
...
class RequestLoggingFilter extends OncePerRequestFilter {
	...
	RequestLoggingFilter(ObjectMapper objectMapper, @Value("${sprinai.request-logging.exclude-paths:#{null}}") List<String> pathsToExclude) {
